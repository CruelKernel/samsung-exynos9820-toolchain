/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/dgboter/bbs/rhev-vm1--rhe6x86_64/buildbot/rhe6x86_64--aarch64-none-elf/build/src/gcc/gcc/config/aarch64/aarch64.md'.  */
